const integrations = [
    ...
    },
    {
        ...
        name: "WhatsApp",
        description: "Enabled only if your clinic policy allows it",
        note: true,
    },
    {
        icon: (
        ...
        name: "Email",
        description: "For clinics that receive inquiries via email",
    },
    {
        icon: (
            <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
                        From first message to booked appointment. No app for clients to download.
                    </p>
                </div>
                ...
                <div className="mt-10 text-center">
                    <p className="text-slate-600 text-sm inline-flex items-center gap-2">
                        ...
                        You can request pausing anytime — we disable replies immediately.
                    </p>
                </div>
            </div>
        </section>

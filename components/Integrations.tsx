const integrations = [
    ...
    },
    {
        ...
        name: "WhatsApp",
        description: "Business messaging (if your policy allows)",
    },
    {
        icon: (
            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
        ...
        name: "Telegram",
        description: "Chat messages and group support",
    },
    {
        icon: (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
                        Works where your clients already message
                    </h2>
                    <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
                        Instagram, Facebook, WhatsApp, Telegram — we reply instantly. No app for clients to download.
                    </p>
                </div>
